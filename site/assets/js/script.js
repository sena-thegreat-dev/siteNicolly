document.addEventListener("DOMContentLoaded", () => {
  ...
  const galeriaZe = document.getElementById("galeria-sobrinha");

btnRevelar.addEventListener("click", () => {
  galeriaZe.style.display = "grid"; // ou "block", dependendo do layout da galeria
  princesa.style.display = "block";  // mostra o h2
